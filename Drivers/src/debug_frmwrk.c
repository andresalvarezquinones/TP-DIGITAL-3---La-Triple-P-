/***********************************************************************/ /**
                                                                           * @file        debug_frmwrk.c
                                                                           * @brief        Contains some utilities that
                                                                           *used for debugging through UART
                                                                           * @version        2.0
                                                                           * @date        21. May. 2010
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @param[in]    UARTx    Pointer to UART
                                                                         *peripheral
                                                                         * @param[in]    hexnum    Hex number (8-bit
                                                                         *long)
                                                                         * @return        None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @param[in]    UARTx    Pointer to UART
                                                                         *peripheral
                                                                         * @param[in]    hexnum    Hex number (16-bit
                                                                         *long)
                                                                         * @return        None
                                                                         **********************************************************************/
...
/*********************************************************************/ /**
                                                                         ...
                                                                         * @param[in]    UARTx    Pointer to UART
                                                                         *peripheral
                                                                         * @param[in]    hexnum    Hex number (32-bit
                                                                         *long)
                                                                         * @return        None
                                                                         **********************************************************************/
